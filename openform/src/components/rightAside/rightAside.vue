    ...
    <div class="right-aside">
      ...
      <div v-if="itemType == 'inputs' || itemType == 'textAreas'">
        ...
        <div class="input-style" v-if="itemType == 'inputs'">
          <el-input size="small" v-model="inputForm.defaults" placeholder="" @input="setForms"></el-input>
        </div>
        <div class="input-textarea" v-if="itemType == 'textAreas'">
          <el-input size="small" type="textarea" rows="4" v-model="inputForm.defaults" placeholder="" @input="setForms"></el-input>
        </div>
        ...
        <div class="input-textarea">
          <el-input class="text-area-pos" type="textarea" rows="4" size="small" v-model="inputForm.remaind" @input="setForms"></el-input>
        </div>
        ...
        <div class="input-textarea">
          ...
          <el-input :disabled="!itmRequired" class="mt-10" v-model="inputForm.requireText" size="small" @input="setForms"></el-input>
        </div>
        <!-- <div class="right-title">对齐方式</div>
        <div class="input-style">
